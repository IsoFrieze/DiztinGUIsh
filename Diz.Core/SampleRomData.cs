    ...
    public class SampleRomData : Data
    {
        public static SampleRomData SampleData
        {
            get
            {
                ...
                var baseSampleData = CreateSampleBaseRomData();
        ...
        private static SampleRomData CreateSampleBaseRomData()
        {
            return new SampleRomData
            {
                ...
                RomBytes = new RomBytes
                {
                    new RomByte
                    {
                        Rom = 0x78, TypeFlag = FlagType.Opcode, MFlag = true, XFlag = true, Point = InOutPoint.InPoint
                    },
                    ...
                    new RomByte
                    {
                        Rom = 0x5C, TypeFlag = FlagType.Opcode, MFlag = true, XFlag = true, Point = InOutPoint.EndPoint
                    },
                    ...
                    new RomByte
                    {
                        Rom = 0xC2, TypeFlag = FlagType.Opcode, MFlag = true, XFlag = true, Point = InOutPoint.InPoint
                    },
                    ...
                    new RomByte
                    {
                        Rom = 0xBF, TypeFlag = FlagType.Opcode, Point = InOutPoint.InPoint, DataBank = 0x80,
                        DirectPage = 0x2100
                    },
                    ...
                    new RomByte
                    {
                        Rom = 0xAE, TypeFlag = FlagType.Opcode, Point = InOutPoint.InPoint, DataBank = 0x80,
                        DirectPage = 0x2100
                    },
                    new RomByte {Rom = 0x00, TypeFlag = FlagType.Operand, DataBank = 0x80, DirectPage = 0x2100},
                    new RomByte {Rom = 0x00, TypeFlag = FlagType.Operand, DataBank = 0x80, DirectPage = 0x2100},
                    ...
                    new RomByte
                    {
                        Rom = 0x08, TypeFlag = FlagType.Opcode, Point = InOutPoint.InPoint, DataBank = 0x80,
                        DirectPage = 0x2100
                    },
                    ...
                    new RomByte
                    {
                        Rom = 0xC2, TypeFlag = FlagType.Opcode, MFlag = true, DataBank = 0x80, DirectPage = 0x2100
                    },
                    new RomByte {Rom = 0x10, TypeFlag = FlagType.Operand, DataBank = 0x80, DirectPage = 0x2100},
                    new RomByte
                    {
                        Rom = 0xA2, TypeFlag = FlagType.Opcode, MFlag = true, DataBank = 0x80, DirectPage = 0x2100
                    },
                    ...
                    new RomByte
                    {
                        Rom = 0xBD, TypeFlag = FlagType.Opcode, MFlag = true, Point = InOutPoint.InPoint,
                        DataBank = 0x80, DirectPage = 0x2100
                    },
                    new RomByte
                    {
                        Rom = 0x5B, TypeFlag = FlagType.Operand, DataBank = 0x80, DirectPage = 0x2100
                    }, // Test_Data
                    new RomByte
                    {
                        Rom = 0x80, TypeFlag = FlagType.Operand, DataBank = 0x80, DirectPage = 0x2100
                    }, // Test_Data

                    // STA.W $0100,X
                    new RomByte
                    {
                        Rom = 0x9D, TypeFlag = FlagType.Opcode, MFlag = true, DataBank = 0x80, DirectPage = 0x2100
                    },
                    new RomByte {Rom = 0x00, TypeFlag = FlagType.Operand, DataBank = 0x80, DirectPage = 0x2100},
                    ...
                    new RomByte
                    {
                        Rom = 0xCA, TypeFlag = FlagType.Opcode, MFlag = true, DataBank = 0x80, DirectPage = 0x2100
                    },

                    // BPL CODE_80804F
                    new RomByte
                    {
                        Rom = 0x10, TypeFlag = FlagType.Opcode, MFlag = true, Point = InOutPoint.OutPoint,
                        DataBank = 0x80, DirectPage = 0x2100
                    },
                    ...
                    new RomByte
                    {
                        Rom = 0xAB, TypeFlag = FlagType.Opcode, MFlag = true, DataBank = 0x80, DirectPage = 0x2100
                    },
                    new RomByte
                    {
                        Rom = 0x28, TypeFlag = FlagType.Opcode, MFlag = true, DataBank = 0x80, DirectPage = 0x2100
                    },
                    new RomByte
                    {
                ...
                Labels = new ObservableDictionary<int, Label>()
                {
                    {
                        0x808000 + 0x00,
                        new Label {Name = "Emulation_RESET", Comment = "Sample emulation reset location"}
                    },
