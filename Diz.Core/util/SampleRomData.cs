...
namespace Diz.Core.util
{
    public class SampleRomData : Data
    {
        ...
        public static SampleRomData CreateSampleData()
        {
            ...
            {
                new(0x808000 + 0x00, new Label {Name = "Emulation_RESET", Comment = "Sample emulation reset location"}),
                new(0x808000 + 0x0A, new Label {Name = "FastRESET", Comment = "Sample label"}),
                new(0x808000 + 0x32, new Label {Name = "Test_Indices"}),
                new(0x808000 + 0x3A, new Label {Name = "Pointer_Table"}),
                new(0x808000 + 0x44, new Label {Name = "First_Routine"}),
                new(0x808000 + 0x5B, new Label {Name = "Test_Data", Comment = "Pretty cool huh?"})
            });
