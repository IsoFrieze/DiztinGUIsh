...
{
    public class LabelListUserControl : ReactiveUserControl<LabelsViewModel>
    {
        public DataGrid MainGrid => this.FindControl<DataGrid>("MainGrid");

        public LabelListUserControl()
        {
...
//                this.BindCommand(ViewModel,
        ...
        // {
        //     if (e.Row.DataContext is not Label byteEntryDetailsViewModel)
        //         return;
        //
        //     // set colors/etc
