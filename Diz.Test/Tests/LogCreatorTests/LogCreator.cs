...
namespace Diz.Test
{
    public sealed class LogCreatorTests
    {
        ...
        public void TestLabelCount()
        {
            ...
            Assert.Equal(2, InputRom.Labels.Labels.Count());
        }
        ...
        public LogCreatorTests(ITestOutputHelper debugWriter)
        {
            ...
            InputRom.Labels.AddLabel(0x808000 + 0x06, new Label {Name = "Test22"});
            InputRom.Labels.AddLabel(0x808000 + 0x5B, new Label {Name = "Test_Data", Comment = "Pretty cool huh?"});
        }
    }
}