...
namespace Diz.Test.Tests.ByteEntry
{
    public static class ByteCombineTests
    {
        ...
        {
            var entry1 = new Core.model.byteSources.ByteEntry(new Core.model.byteSources.AnnotationCollection
            {
                new Label {Name = "test1111"}, new ByteAnnotation(), new Comment()
            }) {DontSetParentOnCollectionItems = true};

            var entry2 = new Core.model.byteSources.ByteEntry(new Core.model.byteSources.AnnotationCollection
            {
        ...
        private static Core.model.byteSources.ByteEntry CreateByteOneLabel(string labelName, bool dontSetParentOnCollectionItems = false)
        {
            return CreateByteOneAnnotation(new Label {Name = labelName}, dontSetParentOnCollectionItems);
        }

        private static Core.model.byteSources.ByteEntry CreateByteOneAnnotation(Annotation annotation,
            bool dontSetParentOnCollectionItems = false)
        {
            var entry = new Core.model.byteSources.ByteEntry(new Core.model.byteSources.AnnotationCollection {annotation})
            {
