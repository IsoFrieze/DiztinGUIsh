...
namespace Diz.Test.Tests.RomInterface
{
    public static class AccessTests
    {
        ...
        public static void TestParentsSetupCorrectly()
        {
            ...
            data.SnesAddressSpace.Bytes[0xC00000] = new Core.model.byteSources.ByteEntry
            {
                Byte = 0xEE,
            };
        ...
        private static void TestParentByteSourceRefs(int expectedByteVal, int index, Core.model.byteSources.ByteSource expectedByteSource)
        {
